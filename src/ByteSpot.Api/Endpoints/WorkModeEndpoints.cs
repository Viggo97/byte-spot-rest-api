...
public static class WorkModeEndpoints
{
    ...
    public static WebApplication MapWorkModeEndpoints(this WebApplication app)
    {
        ...
        workModesGroup
            .MapGet("", async (IQueryHandler<GetWorkModesQuery, IEnumerable<WorkModeDto>> handler,
        ...
        workModesGroup
            .MapGet("{id:int}", async (int id, IQueryHandler<GetWorkModeQuery, WorkModeWithTranslationsDto> handler) =>
            {
        ...
        workModesGroup
            .MapPost("", async (AddWorkModeCommand command, ICommandHandler<AddWorkModeCommand> handler) =>
            {
        ...
        workModesGroup
            .MapPut("{id:int}", async (int id, [FromBody] UpdateWorkModeCommand command,
        ...
        workModesGroup
            .MapDelete("{id:int}", async (int id, ICommandHandler<RemoveWorkModeCommand> handler) =>
            {
