...
public static class EmploymentTypeEndpoints
{
    ...
    public static WebApplication MapEmploymentTypeEndpoints(this WebApplication app)
    {
        ...
        employmentTypesGroup
            .MapGet("", async (IQueryHandler<GetEmploymentTypesQuery, IEnumerable<EmploymentTypeDto>> handler,
        ...
        employmentTypesGroup
            .MapGet("{id:int}",
                async (int id, IQueryHandler<GetEmploymentTypeQuery, EmploymentTypeWithTranslationsDto> handler) =>
                {
        ...
        employmentTypesGroup
            .MapPost("", async (AddEmploymentTypeCommand command, ICommandHandler<AddEmploymentTypeCommand> handler) =>
            {
        ...
        employmentTypesGroup
            .MapPut("{id:int}", async (int id, [FromBody] UpdateEmploymentTypeCommand command,
        ...
        employmentTypesGroup
            .MapDelete("{id:int}", async (int id, ICommandHandler<RemoveEmploymentTypeCommand> handler) =>
            {
