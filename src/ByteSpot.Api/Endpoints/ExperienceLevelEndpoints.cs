...
public static class ExperienceLevelEndpoints
{
    ...
    public static WebApplication MapExperienceLevelEndpoints(this WebApplication app)
    {
        ...
        experienceLevelsGroup.MapGet("", async (IQueryHandler<GetExperienceLevelsQuery, IEnumerable<ExperienceLevelDto>> handler, HttpContext httpContext) =>
        {
        ...
        experienceLevelsGroup.MapGet("{id:int}", async (int id, IQueryHandler<GetExperienceLevelQuery, ExperienceLevelWithTranslationsDto> handler) =>
        {
        ...
        experienceLevelsGroup.MapPost("", async (AddExperienceLevelCommand command, ICommandHandler<AddExperienceLevelCommand> handler) =>
        {
            await handler.HandleAsync(command);
            return Results.Created();
        });
        
        experienceLevelsGroup.MapPut("{id:int}", async (int id, [FromBody] UpdateExperienceLevelCommand command,
        ...
        experienceLevelsGroup.MapDelete("{id:int}", async (int id, ICommandHandler<RemoveExperienceLevelCommand> handler) =>
        {
